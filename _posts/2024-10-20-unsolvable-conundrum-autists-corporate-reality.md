...
- You may not express excitement sufficiently, and you would be perceived as negative and a party popper. As it happens, I am not good at pretending and I rarely get excited about anything, and it is almost never the thing corporate would expect me to be excited about. In an extreme case, due to this (and due to following escalation path in certain circumstances) I ended up with an annual performance review calling me _a two-faced person_.

### Why do I struggle with this as an autist?

The primary reason why it is difficult to navigate such environment is taking communication at face value. In order to be able to understand what the other person needs, I need them to speak about it openly rather than expect me to read their mind. Likewise, when I communicate with others, I usually choose direct, transparent and open (sometimes overly open) communication style as this is the kind of message I would appreciate and find understandable. As it happens, such style is often found offensive by neurotypical people, especially from strongly hierarchical and indirect cultures. It is typically assumed I do this with malicious intent, and I rarely get a chance to explain myself - and never on equal footing.
...
- Company values may include prioritizing customer experience, but then there is no Quality Assurance in place, and I am being told I should not test my changes since there is no time,
...
- I may be told the timeline is tight and there is no time for technical improvements, only to end up stuck and unable to meet deadlines because of technical debt - but still forbidden to address even the smallest wins,
...
If it is truly important to do (or not do) something, the best way is to be open and direct about it. It is immensely helpful to communicate all vital expectations directly, and similarly be precise about which requirements are only optional, conditional or nice-to-have. This way, chances that I would meet your expectations are greatly increased, since the single crucial obstacle is removed.
...
- My performance reviews usually focus on my weaknesses and the necessity to improve on them, and my strengths are rarely noticed or praised - and even then, mostly to sweeten the rather bitter reality that I do not meet the company's expectations. It is rare, though, that I am genuinely able to implement the corrective measures, as they are usually tailored for neurotypicals, and communicated in a way suitable for a neurotypical person.

Needless to say, I do not fare well in performance reviews. I consistently get poor to average scores due to my struggles to fit in, my direct communication style being uncomfortable if not offensive for my peers, and my general inability to act diplomatically or put myself in another person's shoes. I am also poor at advocating for myself to better expose my technical contributions - since according to the rules I am compelled to follow, these contributions are insignificant if I still failed to deliver the outdated OKRs.
